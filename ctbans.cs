            ...
            for (int i = 1; i < Server.MaxPlayers; i++)
            {
                ...
                if (Showinfo[client.Index] == 1)
                {
                    ...
                    (
                        ...
                        $"You are <font color='red'>banned</font> from <font color='blue'>CT</font>!<br>" +
                        $"<font>time left: </font> <font color='red'>{remaining[client.Index]}</font><br>" +
                        $"<font>reason: </font>  <font color='red'>{reason[client.Index]}</font><br>"
                    );
